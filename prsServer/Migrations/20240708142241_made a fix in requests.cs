...
{
    /// <inheritdoc />
    public partial class madeafixinrequests : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestLines_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RequestLines_Requests_RequestsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestLines_ProductsId",
                table: "RequestLines",
                column: "ProductsId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestLines_RequestsId",
                table: "RequestLines",
                column: "RequestsId");
